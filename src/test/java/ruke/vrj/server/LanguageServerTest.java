...
public class LanguageServerTest {
    ...
    public void mustSuggestCompatibleType() {
        ...
        expected.add("suggest",
            Json.object().add("suggestions",
                Json.array().asArray()
                    .add(Json.object().add("label", "myRealVar").add("kind", LanguageServer.VARIABLE_TYPE))
                    .add(Json.object().add("label", "myIntegerVar").add("kind", LanguageServer.VARIABLE_TYPE))
                    .add(Json.object().add("label", "foo").add("kind", LanguageServer.FUNCTION_TYPE))
            )
        );
        ...
        expected.add("suggest",
            Json.object().add("suggestions",
                Json.array().asArray()
                    ...
                    .add(Json.object().add("label", "ChangeLevel").add("kind", LanguageServer.FUNCTION_TYPE))
                    .add(Json.object().add("label", "ChooseRandomItem").add("kind", LanguageServer.FUNCTION_TYPE))
            )
        );
    ...
    public void mustSuggestCompatibleNativeType() {
        ...
        expected.add("suggest",
            Json.object().add("suggestions",
                Json.array().asArray()
                    .add(Json.object().add("label", "GetLocalPlayer").add("kind", LanguageServer.FUNCTION_TYPE))
            )
        );
    ...
    public void mustSuggestRespectingCursor() {
        ...
        expected.add("suggest",
            Json.object().add("suggestions",
                Json.array().asArray()
                    .add(Json.object().add("label", "GetHandleId").add("kind", LanguageServer.FUNCTION_TYPE))
            )
        );
